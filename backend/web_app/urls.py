...
urlpatterns = [
    ...
    path("get_soil_data/<int:station_number>", views.get_soil_data, name="get soil data"),
    path("get_temperature_pressure_data/<int:station_number>", views.get_temperature_pressure_data, name="get temperature pressure data"),
